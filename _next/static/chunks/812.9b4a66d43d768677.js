...
class MerkleWitness256 extends (0,snarkyjs__WEBPACK_IMPORTED_MODULE_0__/* .MerkleWitness */ .Pj)(256) {
}
const state = {
    mCashZkApp: null,
    zkapp: null,
...
const functions = {
    ...
    loadContract: async (args)=>{
        const { mCashZkApp  } = await __webpack_require__.e(/* import() */ 834).then(__webpack_require__.bind(__webpack_require__, 8834));
    ...
    createDepositTransaction: async (args)=>{
        const nullifier = snarkyjs__WEBPACK_IMPORTED_MODULE_0__/* .Field.fromJSON */ .gN.fromJSON(args.nullifier);
        const secret = snarkyjs__WEBPACK_IMPORTED_MODULE_0__/* .Field.fromJSON */ .gN.fromJSON(args.secret);
        let witness = [];
        args.commitmentWitness.isLeft.forEach((isLeft, index)=>{
            witness.push({
                isLeft: isLeft,
                sibling: snarkyjs__WEBPACK_IMPORTED_MODULE_0__/* .Field.fromJSON */ .gN.fromJSON(args.commitmentWitness.path[index])
            });
        });
        const commitmentWitness = new MerkleWitness256(witness);
        const caller = snarkyjs__WEBPACK_IMPORTED_MODULE_0__/* .PrivateKey.fromBase58 */ ._q.fromBase58(args.caller);
    ...
    createWithdrawTransaction: async (args)=>{
        ...
        args.nullifierWitness.isLeft.forEach((isLeft, index)=>{
            nullifierWitness.push({
                isLeft: isLeft,
                sibling: snarkyjs__WEBPACK_IMPORTED_MODULE_0__/* .Field.fromJSON */ .gN.fromJSON(args.nullifierWitness.path[index])
            });
        });
...
/******/ 			return "static/chunks/" + (chunkId === 829 ? "cc8f0cfa" : chunkId) + "." + {"829":"1499682237b782a0","834":"bb034096342a0f4f"}[chunkId] + ".js";
/******/ 		};
/******/ 	}();
/******/ 	
...
/******/ 	!function() {
/******/ 		__webpack_require__.p = "/mCash//_next/";
/******/ 	}();
/******/ 	
